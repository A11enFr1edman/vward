...
class Groupseen extends CActiveRecord
{
	 ...
	 * @return Groupseen the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('project_id, group_id, user_id, last_seen', 'required'),
			array('project_id, group_id, user_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, project_id, group_id, user_id, last_seen', 'safe', 'on'=>'search'),
		);
	}
