...
/**
 * This is the model class for table "auth_group_permissions".
 *
 * The followings are the available columns in table 'auth_group_permissions':
 * @property integer $id
 ...
 */
class AuthGroupPermissions extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AuthGroupPermissions the static model class
	 */
