 ...
 * @property AuthGroupPermissions[] $authGroupPermissions
...
class AuthPermission extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, content_type_id, codename', 'required'),
			array('content_type_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>50),
			array('codename', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, content_type_id, codename', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'authGroupPermissions' => array(self::HAS_MANY, 'AuthGroupPermissions', 'permission_id'),
			'authUserUserPermissions' => array(self::HAS_MANY, 'AuthUserUserPermissions', 'permission_id'),
		);
	}
